...
public class Person {
    ...
    private String par1; // Always firstname
    private String par2;// Always lastname
    private String par3;

    private String par4;//Always country
    private String par5;// Always city
    private String par6;// Always pass number

    private String par7;//Always street
    private String par8;
    private String par9;
